function Get-WindowsVersion {
    ...
    if (-not $IsWindows -and ($PSVersionTable.PSVersion.ToString() -notmatch '^5.1')) {
        Write-Error -Message "This function requires PowerShell (Windows or Core) on Windows OS."
        break
    }
